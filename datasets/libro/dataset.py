...
from asdl.lang.lisp.lisp_transition_system import *
...
def prepare_dataset():
    ...
    grammar = ASDLGrammar.from_text(open('asdl/lang/lisp/lisp_asdl.txt').read())
    transition_system = LispTransitionSystem(grammar)
